...
const Agora_APP_IDD =
    '495879db68cd408bab976327af2c99cc'; // Grab it from: https://www.agora.io/en/
...
const GiphyAPIKey =
    'OntRC8eLB0EqJCOAt2AKzo6AJVdpAllY'; // Grab it from: https://developers.giphy.com/

//*--App Configurations---
const Appname =
    'Konnect'; //app name shown evrywhere with the app where required
